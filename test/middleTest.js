...
describe("#middle", function() {
  ...
  it("should retunr [2, 3] and passed for [1, 2, 3, 4]", () => {
  ...
  it("should return ['d'] for ['a', 'b', 'c', 'd', 'e', 'f', 'g']", () => {
    assert.strictEqual(assertArraysEqual(middle(["a", "b", "c", "d", "e", "f", "g"]), ["d"]));
  }); // => ✅✅✅ Assertion Passed: d === d

  it("should return ['banana', 'carrot'] for ['apple', 'banana', 'carrot', 'durian']", () => {
    assert.strictEqual(assertArraysEqual(middle(["apple", "banana", "carrot", "durian"]), ["banana", "carrot"]));
